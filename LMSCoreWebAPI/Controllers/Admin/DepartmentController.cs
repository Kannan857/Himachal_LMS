...
namespace LMSCoreWebAPI.Controllers.Admin
{
    ...
    public class DepartmentController : ControllerBase
    {
        ...
        public DepartmentController(lmsContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<ActionResult<Department>> PostDepartment(DepartmentDto departmentDto)
        {
            ...
            if (departmentDto.InstitutionId > 0)
            {
                ...
                department.Institutiondepartment = new List<Institutiondepartment> { insDept };
